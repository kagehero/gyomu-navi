...
function ClientFormDialog({
  ...
  const form = useForm<FormValues>({
    ...
    values: { name: initial?.name ?? "", code: initial?.code ?? "" },
  });
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <CardTitle className="text-sm font-medium">顧客企業一覧 ({items.length}件)</CardTitle>
      ...
      <DeleteConfirmDialog
        ...
        description="この顧客に紐づく現場・業務内容・報告がある場合は削除できません。"
